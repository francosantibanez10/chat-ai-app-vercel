...
import { Download, FileText, FileSpreadsheet, FileImage, FileCode, File } from "lucide-react";
...
export default function GeneratedFileViewer({ file, onClose }: GeneratedFileViewerProps) {
      ...
      {isPreviewVisible && file.contentType.includes('image') && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-gray-900 rounded-lg p-4 max-w-4xl max-h-[90vh] overflow-auto">
            ...
            <img
              src={URL.createObjectURL(new Blob([file.buffer], { type: file.contentType }))}
              alt="Vista previa"
