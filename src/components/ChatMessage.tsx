            ...
            <>
              ...
              {metadata && (
                <div className="w-full mt-4 p-3 bg-gray-800/30 border border-gray-600 rounded-lg">
                  <div className="text-xs text-gray-400 mb-2">Información adicional:</div>
                  <div className="text-sm text-gray-300">
                    {metadata.contextAnalysis && (
                      <div className="mb-2">
                        <span className="text-gray-400">Tipo de contexto:</span> {metadata.contextAnalysis.contextType}
                      </div>
                    )}
                    {metadata.queryType && (
                      <div className="mb-2">
                        <span className="text-gray-400">Tipo de consulta:</span> {metadata.queryType}
                      </div>
                    )}
                    {metadata.tokens && (
                      <div className="mb-2">
                        <span className="text-gray-400">Tokens:</span> {metadata.tokens.input} → {metadata.tokens.output}
                      </div>
                    )}
                  </div>
                </div>
